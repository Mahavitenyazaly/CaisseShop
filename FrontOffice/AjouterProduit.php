...
<main class="main-content">
    ...
    <div class="edit-layout">
        ...
        <form action="produits.php" method="POST">
            <div class="form-card">
                ...
                <div class="form-field">
                    <input type="hidden" name="IdProduitUpdated">
                    <label>Nom du produit</label>
                    <input type="text" name="NomP_updated" id="productName">
                </div>

                <div class="form-field">
                    <label>Description</label>
                    <textarea name="Description_Updated" rows="4"></textarea>
                </div>

                <div class="inline-fields">
                    <div class="form-field">
                        <label>Prix</label>
                        <input type="text" name="PrixUpdated" id="priceValue" class="input-teal">
                    </div>
                    <div class="form-field">
                        <label>Stock</label>
                        <input type="text" name="StockUpdated" class="input-teal input-center">
                    </div>
                    <div class="form-field barcode-field">
                        <label>Code-barres</label>
                        <input type="text" name="CodebarresUpdated" id="barcodeValue">
                    </div>
                </div>
        ...
        <div class="barcode-panel">
            <div class="status" id="statusBox">Chargement DYMO...</div>
